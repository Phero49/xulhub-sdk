/**
 * Drag-and-drop plus click-to-upload file handler.
 *
 * @param {HTMLElement} container The drop/click target.
 ...
 *@throws thows an error when creation failed 
 */
  ...
  function handleFiles(files: File[]) {
    files.forEach(file => {
      ...
      if (typeof maxSize === 'number' && file.size > maxSize) {
        console.warn('File too large:', file);
        return;
      }
